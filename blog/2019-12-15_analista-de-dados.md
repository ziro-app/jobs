...
O analista de dados tem perfil fortemente analítico e sente-se à vontade manipulando planilhas e realizando queries SQL.

Buscamos alguém que nos ajude a interpretar nosso momento atual através de KPIs, que consiga tomar decisões e que também ponha bastante a mão na massa, criando e executando os processos necessários e automatizando os existentes.

## Responsabilidades

* Desenvolvimento de fórmulas QUERY em Google Sheets
* Desenvolvimento de scripts em Google Sheets
* Automação de processos, usando softwares da Ziro ou de mercado
* Integração de planilhas em APIs da Ziro ou APIs públicas
* Análises de dados gerados por nossos processos internos

## Remuneração

Contratação PJ no valor de R$3.500,00. Trabalho remoto em horário flexível.

## Processo

Caso tenha interesse em trabalhar conosco, as etapas do processo serão:

1. Teste em planilha Google Sheets. <a href='https://bit.ly/teste-dados' target='_blank'>Acessar aqui</a>.
2. Conversa com sócios.

O processo inicia-se após o envio da sua resolução do <a href='https://bit.ly/teste-dados' target='_blank'>teste em planilha</a> para o email: vitor@ziromoda.com.br
