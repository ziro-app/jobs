...
* **Obs 2.:** Gentileza não enviar emails contendo apenas currículos anexados. Não consideraremos emails sem o link para sua planilha de resolução.

Será agendada uma video-chamada para que você explique sua resolução.

No teste, mais do que a resposta final em si, será considerada sua resiliência e capacidade de aprendizado/evolução.

Caso tenha dúvidas acerca do processo, fique à vontade para enviar uma mensagem para o mesmo email acima.
